...
> This is the skill-dir copy that `writing-skills-sre/SKILL.md` references. The repo-level `docs/persuasion-principles.md` covers the same principles for the broader srepowers audience; keep the two in sync when either changes.
...
- [Testing Infrastructure Skills With Subagents](testing-skills-with-subagents.md)
