...
For infrastructure-specific skills, apply the same TDD approach with these patterns:
...
1. **Exact commands** - Copy-pasteable with environment variables
2. **Verification steps** - How to confirm action succeeded
3. **Rollback documentation** - How to undo if something goes wrong
4. **Dependencies** - Prerequisites before starting
